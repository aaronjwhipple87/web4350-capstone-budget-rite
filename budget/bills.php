...
<div class="column">
    <section class="section">
        <div class="container">
            <h1 class="title">Current Bills</h1>
            <p class="subtitle">Welcome, you can view, edit or delete current bills below.</p>
            <a href="addTrans.php" class="button is-success is-small">
                <span class="icon"><i class="fas fa-plus"></i></span>
                <span>Add Transaction</span>
            </a>
            <a href="allBills.php" class="button is-primary is-small">
            ...
            <table class="table is-bordered is-fullwidth">
                ...
                <?php foreach ($trans as $row): ?>
                    <tr>
                        ...
                        <td>
                            <a href="editTrans.php?id=<?=$row['transactionID']?>" class="button is-link is-small" title="Edit Bill">
                                <span class="icon"><i class="fas fa-edit"></i></span>
                            </a>
                            <a href="deleteTrans.php?id=<?=$row['transactionID']?>" class="button is-danger is-small" title="Delete Bill">
